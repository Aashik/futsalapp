...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href='ground.php'><i class="fa fa-circle-o"></i> Ground</a></li>
            <li><a href='employee.php'><i class="fa fa-circle-o"></i> Employee</a></li>
  ...
  <div class="content-wrapper" id="contentBox">
